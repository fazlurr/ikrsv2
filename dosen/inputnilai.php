...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <body style="; background-color:#556;
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <table class="table table-hover">
            ...
            <?
              $info = mysql_query("SELECT user.user_id, user.name, krs.semester, krs.tahun FROM user LEFT JOIN krs ON user.user_id=krs.user_id WHERE krs.nomor='$nomor'");
          ...
          <form name="isinilai" method="post" action="">
              <input type="text" name="nilai" value="" placeholder="A, B, C, D, E"><br>
