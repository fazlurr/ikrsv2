<?php require_once('../Connections/rpl.php'); ?>
<?php
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $rpl) or die(mysql_error());

  $updateGoTo = "redirect.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['nrp'])) {
  $colname_Recordset2 = $_GET['nrp'];
}
mysql_select_db($database_rpl, $rpl);
$query_Recordset2 = sprintf("SELECT * FROM `user` WHERE user_id = %s", GetSQLValueString($colname_Recordset2, "text"));
$Recordset2 = mysql_query($query_Recordset2, $rpl) or die(mysql_error());
...
<!--[if lt IE 9]>
  ...
  <div class="container">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      ...
      <input type="hidden" name="user_id" value="<?php echo $row_Recordset2['user_id']; ?>">
    </form>
    <p>&nbsp;</p>
  </div> <!-- /container -->
