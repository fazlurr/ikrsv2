    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="http://localhost/multi-login">iKRS</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="http://localhost/multi-login/indexuser.php">Home</a></li>
              <li><a href="http://localhost/multi-login/inputkrs.php">Input KRS</a></li>
              <li><a href="http://localhost/multi-login/logout.php"><i class="icon-signout"></i>Logout</a></li>
